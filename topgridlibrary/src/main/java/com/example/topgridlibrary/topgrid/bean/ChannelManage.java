...
//		}
	...
	static {
		...
		defaultUserChannels.add(new ChannelItem(2, "关注=2510", 2, 1,0));
		defaultUserChannels.add(new ChannelItem(3, "推荐=2511", 3, 1,0));
		defaultUserChannels.add(new ChannelItem(4, "热点=2515", 4, 1,0));
		defaultUserChannels.add(new ChannelItem(5, "北京=2517", 5, 1,0));
		defaultUserChannels.add(new ChannelItem(6, "视频=2518", 6, 1,0));
		defaultUserChannels.add(new ChannelItem(7, "新时代=2516", 7, 1,0));
